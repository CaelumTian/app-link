...
(function (win) {
    ...
    var Applink = function () {
        ...
        _createClass(Applink, [{
            ...
            key: "setParam",
            value: function setParam(uuid, params) {
            ...
            key: "setData",
            value: function setData(uuid, chunk) {
    ...
    Applink.PARAM_PREFIX = "param_";
    Applink.CHUNK_PREFIX = "chunk_";
